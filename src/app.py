"""
QwenASR Pro - Main Application
API-driven, no hardcoded models
"""
...
class App(ctk.CTk):
    ...
    def _initialize(self) -> None:
        try:
            ...
            self.ui.asr_backend_var.set(current["asr_backend"])
            self.ui.asr_model_var.set(current["asr_model"])
            self.ui.asr_url_var.set(current["asr_api_url"])
            self.ui.translate_backend_var.set(current["translate_backend"])
